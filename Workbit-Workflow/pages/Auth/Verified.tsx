                        ...
                        <div className="flex flex-col space-y-6">
                              ...
                              <div className="flex relative flex-col gap-2 px-4">
                                    <p className='text-[2rem] text-center'>
                                          <span className='text-gray-800'>Email Verfication</span>
                                    </p>
                                    <p className='text-wrap text-center'>Your email address was successfully verified. You can continue using the application.</p>
                                    <div className="flex flex-col w-full relative items-center justify-center my-2">
                                          <Link to={'/auth/login'} className="px-7 py-3 bg-slate-200 border-1 border-slate-300 rounded-full">
