...
import { Email, EmailAuthProps } from "@/types/types";
...
const EmailLogin = () => {
      ...
      const [formData, setFormData] = useState<EmailAuthProps>({ email: "", password: "" });
            ...
            <div className="bg-white rounded-[2.5rem] space-y-6">
                  ...
                  <form onSubmit={handleSigning} className="bg-white rounded-[2.5rem] border-none border-slate-100 space-y-6">
                        ...
                        <div className="flex flex-col item-center-w-full relative space-y-6 md:gap-2">
                              ...
                              <AuthPasswdInput value={formData.password} id="password" name="password
                              " icon={<LockIcon size={16} />} label="Password" placeholder="Your account password" required
                                    onChange={(e) =>
                                          setFormData({
                                                ...formData,
