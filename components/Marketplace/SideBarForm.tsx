...
const SideBarForm = ({
      ...
      return (
            <form
                  onSubmit={(e) =>
                        handleOnSubmit(e, { proof, p_url, selectedImage })
                  }
            ...
            >
                  <div className="space-y-2">
                        ...
                        <p className="text-xs text-slate-500 font-medium">
                              {' '}
                              Please provide accurate proof as instructed to
                              ensure your payout is approved.
                        </p>
                  </div>
                  ...
                  <div className="space-y-4">
                        <label
                              htmlFor="screenshot1"
                              className={`relative flex min-h-[100px] w-full rounded-xl overflow-hidden border-2 ${imagePreview && imagePreview.img1?.length && imagePreview.img1?.length > 0 ? 'border-slate-100 border-solid' : 'border-dashed border-blue-600'}`}
                        >
                              <div className="flex flex-1 flex-col relative w-full cursor-pointer overflow-hidden">
                                    <div className="block w-full relative">
                                          <img
                                                src={
                                                      imagePreview.img1 as string
                                                }
                                                alt={
                                                      imagePreview.img1 as string
                                                }
                        ...
                        <label
                              htmlFor="screenshot2"
                              className={`relative flex min-h-[100px] w-full rounded-xl overflow-hidden border-2 ${imagePreview && imagePreview.img2?.length && imagePreview.img2?.length > 0 ? 'border-slate-100 border-solid' : 'border-dashed border-blue-600'}`}
                        >
                              <div className="flex flex-1 flex-col relative w-full cursor-pointer overflow-hidden">
                                    <div className="block w-full relative">
                                          <img
                                                src={
                                                      imagePreview.img2 as string
                                                }
                                                alt={
                                                      imagePreview.img2 as string
                                                }
                                    ...
                                    />
                                    <div className="flex items-center justify-center p-4 h-full w-full gap-3 text-blue-600 text-xl">
                                          <UploadCloud size={30} /> Upload After
                                          Screenshot
                                    </div>
                              </div>
                        </label>
                        ...
                        {job.requires_screenshot && (
                              <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
                                    <p className="text-xs text-blue-700 font-semibold flex items-center gap-2">
                                          <AlertCircle size={30} /> Remember to
                                          upload your screenshot here and
                                          provide your social username/ID for
                                          verification.
                                    </p>
                              </div>
                        )}
                        ...
                        <button
                              type="submit"
                              className="w-full bg-blue-600 text-white py-2 rounded-full text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-200"
                        >
