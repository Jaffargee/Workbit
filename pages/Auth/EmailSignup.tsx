...
const EmailSignup = () => {
      ...
      const handleInputChange = useCallback(
            (field: 'email' | 'password', value: string) => {
                  ...
                  if (field === 'password') {
                        setReqPasswd(
                              ValidationService.UIValidatePassword(value)
                        );
                  }
      ...
      return (
            <div className="bg-white rounded-[2.5rem] space-y-6">
                  ...
                  <form
                        ...
                        className="bg-white rounded-[2.5rem] border-none max-sm:space-y-6"
                        noValidate
                  >
                        <div className="flex flex-col items-center w-full relative space-y-6 md:gap-2">
                              ...
                              <div className="w-full">
                                    ...
                                    <div
                                          className={`text-xs text-gray-500 mt-2 ml-2 space-y-1 ${reqPasswd.length === 0 ? 'hidden' : ''}`}
                                    >
