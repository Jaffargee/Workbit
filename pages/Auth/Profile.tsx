...
//             errs.push({
//                   field: 'p_account_number',
//                   message: 'Account number must be exactly 10 digits',
//             });

//       if (!data.p_account_name.trim())
//             errs.push({
//                   field: 'p_account_name',
...
//       const set =
//             (field: keyof ProfileSetupPayload) =>
...
//                               p_account_name: form.p_account_name
//                                     .trim()
//                                     .toUpperCase(),
...
//                                                 label="State"
//                                                 value={
//                                                       form.p_state as NigerianState
//                                                 }
//                                                 onChange={(e) => {
//                                                       setForm((prev) => ({
//                                                             ...prev,
//                                                             p_state: e.target
//                                                                   .value as NigerianState,
//                                                       }));
//                                                       setErrors((prev) =>
//                                                             prev.filter(
//                                                                   (err) =>
...
//                                           {
//                                                 value: 'WORKER',
//                                                 data: 'Earn money by completing tasks (Worker)',
//                                           },
//                                           {
//                                                 value: 'EMPLOYER',
//                                                 data: 'Post tasks and hire workers (Employer)',
//                                           },
//                                           {
//                                                 value: 'BOTH',
//                                                 data: 'Both — earn and post tasks',
//                                           },
//                                     ]}
...
//                                           Your account details are encrypted and
//                                           only used for withdrawals. You can
...
//                               className="w-full bg-blue-600 text-white py-3.5 rounded-full font-semibold hover:bg-blue-700 transition-all shadow-md shadow-blue-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
//                         >
//                               {loading ? (
//                                     <>
//                                           <Loader2
...
const FieldError: React.FC<{ errors: ValidationError[]; field: string }> = ({
      errors,
      field,
}) => {
      const styles = useStyles();
      const msg = getFieldError(errors, field);
      if (!msg) return null;
      return <Text className={styles.fieldError}>{msg}</Text>;
};
...
export const Profile = () => {
      ...
      const setFieldValue =
            (field: keyof ProfileSetupPayload) => (value: string) => {
      ...
      return (
            <div className={styles.root}>
                  ...
                  >
                        ...
                        <div className={styles.card}>
                              <SectionHeader
                                    icon={<PaymentRegular fontSize={16} />}
                                    title="Payment Details"
                                    subtitle="Where your earnings will be sent"
                              />
                              ...
                              <div>
                                    <AuthInput
                                          ...
                                          name="p_bank_name"
                                          icon={
                                                <PaymentRegular fontSize={14} />
                                          }
                                          label="Bank Name"
                                          placeholder="e.g. GTBank, Access Bank"
                                          required
                                          onChange={setField('p_bank_name')}
                                    />
                                    <FieldError
                                          errors={errors}
                                          field="p_bank_name"
